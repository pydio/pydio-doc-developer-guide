...
ENVIRONMENT
  ...
  - CELLS_GRPC_AUTHORITY: :authority header value passed in all GRPC clients calls
  ...
  - CELLS_LDAP_BACKOFF_DURATION (100ms): Customize LDAP retries timing
  - CELLS_LDAP_RETRIES_NUMBER (5): Customize LDAP retries number
