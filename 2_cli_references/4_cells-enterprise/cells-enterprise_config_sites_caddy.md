## ./cells-enterprise config sites caddy

Dump content of the caddy file currently served by pydio.gateway.proxy
...
```
./cells-enterprise config sites caddy [flags]
```
...
* [./cells-enterprise config sites](./cells-enterprise-config-sites)	 - Manage sites where application is exposed
