...
```
./cells-enterprise token [flags]
```

### Options

```
  -a, --auto int        Auto-refresh (in seconds)
  -e, --expire string   Expire after ... 
  -h, --help            help for token
  -s, --scope strings   Optional scopes (multiple)
